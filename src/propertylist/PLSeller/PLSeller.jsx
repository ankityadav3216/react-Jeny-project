...
const PLSeller = () => {
  ...
  return (
    <div className="pl-seller-section">
      ...
      <div className="pl-seller-container" ref={containerRef}>
        {sellers.map((seller, index) => (
          <div className="pl-seller-card" key={index}>
            <div className="seller-header" style={{ background: index % 2 === 0 ? "#3b3f5c" : "#1e3a5f" }}>
              <img src={seller.image} alt={seller.name} />
              <span>{seller.name} &gt;</span>
            </div>
            <div className="seller-details">
              <p>
                <b>{seller.experience}</b> Experience | <b>{seller.properties}</b> Properties
              </p>
